                ...
                {professors.map((professor) => (
                    <TableRow key={professor.id}>
                        ...
                        <TableCell className="action-buttons">
                            <Button variant="outlined" onClick={() => handleUpdate(professor.id)}>Atualizar</Button>
                            <Button variant="outlined" onClick={() => handleDelete(professor.id)} color="error">Deletar</Button>
                        </TableCell>
                    </TableRow>
                ))}
            </Table>
